...
#sync; timeout $to "mpirun -np 16 ./RPX10 hoge $pid $prec 1 2 $pa";
sync; timeout $to "mpirun -np 32 ./RPX10 hoge $pid $prec 1 2 $pa";
sync; timeout $to "mpirun -np 40 ./RPX10 hoge $pid $prec 1 2 $pa";
echo ""
